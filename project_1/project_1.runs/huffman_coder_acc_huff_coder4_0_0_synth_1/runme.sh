...
HD_PWD='F:/MAGISTERKA_S1/SDUP/PROJEKT_HUFFMAN_V2/project_1/project_1.runs/huffman_coder_acc_huff_coder4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log huffman_coder_acc_huff_coder4_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source huffman_coder_acc_huff_coder4_0_0.tcl
