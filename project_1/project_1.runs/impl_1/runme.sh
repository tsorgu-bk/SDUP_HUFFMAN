...
HD_PWD='F:/MAGISTERKA_S1/SDUP/PROJEKT_HUFFMAN_V2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log huffman_coder_acc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source huffman_coder_acc_wrapper.tcl -notrace
